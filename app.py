...
def progress_markup(percent: float, status: str, speed: str, eta: str) -> str:
    ...
    if submitted:
        ...
        if existing_files and not allow_redownload:
            ...
            progress_placeholder.markdown(
                progress_markup(0, "Preparing download", "Checking connection", "calculating"),
                unsafe_allow_html=True,
            )
            ...
            def update_progress(info: dict) -> None:
                if info["status"] == "downloading":
                    ...
                    progress_placeholder.markdown(
                        progress_markup(1.0, "Download finished", "Merging MP4", "almost done"),
                        unsafe_allow_html=True,
                    )
